...
4. docs/2-需求规格/requirements.md（V1.0 功能规格）
5. docs/2-需求规格/requirements-v1x.md（V1.x 迭代需求）
6. docs/4-规范与指南/MyPurse开发规范.md（重点关注 2.3、11 节）
7. docs/3-开发过程/开发阶段.md（当前进度）
8. docs/4-规范与指南/通用开发规范.md（重点关注 0.3 节）
```
...
| 3 | 问题记录 | 修复了 Bug 但没在 `问题记录.md` 中追加记录 | 只修不记，后人不知踩过什么坑 |
